...
- [Hướng dẫn đóng góp](https://github.com/Truongpyeo/DTUDZ2_Admin/blob/master/CONTRIBUTING.md)

## 🤝 Đóng góp
Chúng tôi rất hoan nghênh mọi đóng góp! Xem [CONTRIBUTING](https://github.com/Truongpyeo/DTUDZ2_Admin/blob/master/CONTRIBUTING.md) để biết thêm chi tiết.
...
## 📜 Changelog
Xem [CHANGELOG](https://github.com/Truongpyeo/DTUDZ2_Admin/blob/master/CHANGELOG.md) để biết lịch sử thay đổi.

## ⚖️ Code of Conduct
Xem [CODE_OF_CONDUCT](https://github.com/Truongpyeo/DTUDZ2_Admin/blob/master/CODE_OF_CONDUCT.md) để biết các quy tắc và hành vi được chấp nhận.
...
### 📝 License
Dự án được phân phối dưới giấy phép [MIT License](https://github.com/Truongpyeo/DTUDZ2_Admin/blob/master/LICENSE)
